...
crop_methods = {
    ...
    'happywhale-wds384-unsubmerged': None,
    }
gcs_paths = {
    ...
    'happywhale-tfrecords-unsubmerged': 'gs://kds-baceeeb49ef0e1c8956ff8e695bb2a6726b62626521b4d45a571a3ea',
...
def add_image_id(df, cfg):
    ...
    #df = df.iloc[:cfg.bs * (cfg.n_acc or 2) * cfg.num_folds * 80]  # DEBUG
