...
gcs_paths = ['gs://kds-9f5a804882fbba246417d1f05c75641caba36dbcd34c060c876ecaf0', 'gs://kds-db9fa8021acbd25e0fcb90f9772ef994c8ab771c7acbad92eabf3a0a']
gcs_filters = ['*/*-of-*', '*-of-*']
...
blackpoint_range = (-100, 0)   # x-offset
blackpoint2_range = (-100, 0)  # y-offset
