...
# Setup
    ...
    gcs_paths = ['gs://kds-2dda2fde92ce02093d5375341dbd80f2711f6d92817383c025273c93', 
                 'gs://kds-8940ab864787cfb0d28ea44576eb4329dc2e2ebff06cb6c25ca0542e'],
    gcs_filters = ['*/*-of-*', '*-of-*'],
...
# Training
    ...
    lr_min = 1e-6,
    save_best = 'loss',
    loss_weights = [4.0, 11.0, 100.0],  # a, b, bp
    a_sigma = 0.5,
    b_mean = 0.4,
    b_sigma = 0.25,
    bp_sigma = 0.02,
