...
blackpoint_range = (-85, 40)   # x-offset
blackpoint2_range = (-75, 10)  # y-offset
clip_target_blackpoint = True
log_gamma_range = [-1.8, 1.8]
curve3_conditional_a_range = (-1.95, 0.30)
curve3_beta_range = (0.6, 2.0)
mirror_beta = False
...
p_beta = 0.57143               # probability for using Beta PDF rather than Curve4
