...
parser.add_argument("--dropout_ps", nargs="+", type=float, default=None, help="Dropout probabilities for head Dropout layers")
parser.add_argument("--lin_ftrs", nargs="+", type=int, default=None, help="None or output dims of linear (FC) head layers before the output layer")
